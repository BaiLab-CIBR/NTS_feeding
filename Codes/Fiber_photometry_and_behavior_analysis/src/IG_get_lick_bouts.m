function [boutStartSec, boutEndSec, lickRatePerbout, consumptionRatePerbout] = IG_get_lick_bouts(date, mouseID, events, FR, startTime, waterStart, waterEnd)
...
intervalThreshold=3; % 3s as the thresshold of lick bout intervals
